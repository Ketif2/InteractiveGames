    ...
    return (
        <div className="min-h-[calc(100vh-10rem)] flex flex-col bg-gray-50">
            ...
            <div className="bg-[#00398A] text-white py-2 px-4 sm:px-6">
                <h1 className="text-lg sm:text-xl font-semibold">Resultados de la Secuencia Numérica</h1>
            </div>
                    ...
                    <section className="bg-white rounded-lg shadow p-3 sm:p-4">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center">
                                <span className="text-sm sm:text-base text-gray-600">Rango de números:</span>
                                <span className="bg-blue-100 px-2 sm:px-3 py-1 rounded text-sm sm:text-base">
                                    {config.startRange} - {config.endRange}
                                </span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-sm sm:text-base text-gray-600">Números a ocultar:</span>
                                <span className="bg-blue-100 px-2 sm:px-3 py-1 rounded text-sm sm:text-base">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className="bg-blue-100 px-2 sm:px-3 py-1 rounded text-sm sm:text-base capitalize">
                                    {config.gameMode}
                                </span>
                            </div>
                        </div>
