    ...
    return (
        <div className="h-[calc(100vh-10rem)] flex flex-col bg-gray-50">
            ...
            <div className="bg-[#00398A] text-white py-2 px-6">
                <h1 className="text-xl font-semibold">Resultados del Juego de Sendero en el Bosque</h1>
            </div>
                ...
                <div className="flex flex-col gap-4 h-full">
                    ...
                    <section className="bg-white rounded-lg shadow p-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex justify-between items-center">
                                <span className="text-gray-600">Densidad de objetos:</span>
                                <span className="bg-blue-100 px-3 py-1 rounded capitalize">
                                    {config?.objectDensity || 'Normal'}
                                </span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-gray-600">Tiempo límite por nivel:</span>
                                <span className="bg-blue-100 px-3 py-1 rounded">
...
// Componente para mostrar elementos de estadísticas (mismo del juego de memoria)
