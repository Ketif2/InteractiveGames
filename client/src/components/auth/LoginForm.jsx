        ...
        <div>
          ...
          <div className="relative rounded-md shadow-sm">
            ...
            <input
              ...
              className="pl-10 py-3 block w-full text-base border border-gray-300 rounded-md shadow-sm focus:ring-[#00A8E3] focus:border-[#00A8E3]"
        ...
        <div>
          ...
          <div className="relative rounded-md shadow-sm">
            ...
            <input
              ...
              onChange={handleChange}
              className="pl-10 pr-10 py-3 block w-full text-base border border-gray-300 rounded-md shadow-sm focus:ring-[#00A8E3] focus:border-[#00A8E3]"
