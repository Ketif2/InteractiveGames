...
const GameControls = ({ onHelp, onPause, onExit, isPaused, gameMode }) => {
    return (
        <div 
            className="bg-[#00398A] shadow-md p-4 flex justify-between items-center"
            role="toolbar"
        ...
        >
            <div className="flex gap-4">
                <button
                    ...
                    aria-label={gameMode === 'memoria' ? 'Mostrar objetos temporalmente' : 'Obtener ayuda para completar un elemento'}
                >
                ...
                <button
                    ...
                    className="px-5 py-2 bg-yellow-100 text-yellow-700 rounded-md 
                             ...
                             flex items-center gap-2 font-medium
                             focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-800"
                    aria-label={isPaused ? 'Continuar el juego' : 'Pausar el juego'}
                >
                    {isPaused ? (
                        <>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
